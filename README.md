...
| Интерактивная область питомца | web media-region в reference frame: `(37.125, 122.906)`, `327.75×450.656` |
...
Полная пошаговая процедура обновления, проверки подписи, установки поверх предыдущей версии и публикации APK: [`RELEASE.md`](RELEASE.md).
